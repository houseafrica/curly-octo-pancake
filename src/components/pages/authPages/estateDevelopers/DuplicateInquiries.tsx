...
import InquiryDetailsModal from 'components/reusables/estateDevelopers/InquiryDetailsModal'



const DuplicateInquiries: FC = (): ReactElement => {
    ...
    return (
        <DuplicateInquiriesScreenWrapper>
            { addNew &&
            ...
            { view && <InquiryDetailsModal setView={setView} /> }
            <div className="row">
...
const DuplicateInquiriesScreenWrapper = styled.div`
    margin-left: 150px;
    padding-top: 30px;
